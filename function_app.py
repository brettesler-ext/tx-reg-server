...
def txdev(req: func.HttpRequest) -> func.HttpResponse:
    ...
    elif "common-languages-australia-1" in req.url or "unitsofmeasure.org" in req.url or "units-of-time" in req.url or "www.rcpa.edu.au" in req.url or "www.iana.org" in req.url or "au-timezone" in req.url:
